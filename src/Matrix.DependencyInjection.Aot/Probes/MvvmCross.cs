...
{
    public const string Library = "MvvmCross";
    ...
    public static int Run()
    {
        ...
        container.LazyConstructAndRegisterSingleton<IProbeSingleton, ProbeSingleton>();
        container.RegisterType<IProbeTransient, ProbeTransient>();
