...
{
    public const string Library = "Singularity";
    ...
    public static int Run()
    {
        ...
        {
            builder.Register<IProbeSingleton, ProbeSingleton>(c => c.With(Lifetimes.PerContainer));
            builder.Register<IProbeTransient, ProbeTransient>(c => c.With(Lifetimes.Transient));
        });
