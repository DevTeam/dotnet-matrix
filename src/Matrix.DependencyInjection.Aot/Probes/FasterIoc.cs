...
{
    public const string Library = "Faster.Ioc";
    ...
    public static int Run()
    {
        ...
        container.Register<IProbeSingleton, ProbeSingleton>(FasterLifetime.Singleton);
        container.Register<IProbeTransient, ProbeTransient>(FasterLifetime.Transient);
