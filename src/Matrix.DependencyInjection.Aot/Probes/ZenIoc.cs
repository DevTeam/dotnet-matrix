...
{
    public const string Library = "ZenIoc";
    ...
    public static int Run()
    {
        ...
        container.Register<IProbeSingleton, ProbeSingleton>().SingleInstance();
        container.Register<IProbeTransient, ProbeTransient>();
        container.Compile();
        using var disposable = (IDisposable)container;
