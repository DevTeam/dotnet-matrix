...
{
    public const string Library = "Unity";
    ...
    public static int Run()
    {
        ...
        container.RegisterType<IProbeSingleton, ProbeSingleton>(new ContainerControlledLifetimeManager());
        container.RegisterType<IProbeTransient, ProbeTransient>(new TransientLifetimeManager());
